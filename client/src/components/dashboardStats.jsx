    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        {cards.map((card, i) => (
          <div
            key={i}
            className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-3 md:p-4 hover:shadow-md transition hover:-translate-y-0.5"
          >
            <div className="flex justify-between items-start">
              <div>
                ...
                <h2 className="text-xl md:text-2xl font-bold text-black dark:text-white mt-0.5">
                  {card.value}
                </h2>
              </div>
              <div className={`p-1.5 md:p-2 rounded-lg ${card.bg}`}>
                <span className={`text-base md:text-lg ${card.color}`}>
                  {card.icon}
                </span>
              </div>
            </div>
